                    ...
                    <div class="card" style="border-top: 3px solid #404E67;">
                        ...
                        <div class="card-block">
                            <div class="table-responsive dt-responsive">
                                <table id="dom-jqry" class="table table-sm table-striped">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Number</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('importDelete', $row->id)}}" onclick="return confirm('Are you sure to want to delete it?')" class="text-muted">Delect</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
